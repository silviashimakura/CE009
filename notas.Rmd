...
author: "|\n| 2026/02 - Departamento de Estatística\n"
subtitle: |
...
notas <- readxl::read_xlsx('notas-chamada.xlsx')

notas$`PROVA 1` <- round(as.numeric(notas$`PROVA 1`)/10,1)
notas$`PROVA 2` <- round(as.numeric(notas$`PROVA 2`)/10,1)
notas$`PROVA 3` <- round(as.numeric(notas$`PROVA 3`)/10,1)

#notas$`PROVA 4` <- round(as.numeric(notas$`PROVA 4`)/10,1)
...
pre_exame <- round(soma_parciais/3, 1)
...
knitr::kable(notas[,c(2,3,6)])
#knitr::kable(notas[,c(2,3,4,5,6,7,80,81,82,83)])
#knitr::kable(notas[,c(2,7,80,81,8,82,83)])
